...
{
    /// <summary>
    /// Checks whether the <paramref name="scenario"/> passes on the given <paramref name="getAnswerFunc"/>
    ...
    public async Task CheckChatScenarioAsync(ChatScenario scenario, Func<ChatHistory, Task<string>> getAnswerFunc)
    {
    ...
    /// <returns></returns>
    /// <exception cref="InvalidOperationException">If the OpenAI was unable to generate a valid response.</exception>
    public async Task CheckChatScenarioAsync(List<ChatScenario> scenarios, Func<ChatHistory, Task<string>> getAnswerFunc)
    {
        foreach (var scenario in scenarios)
        {
            await CheckChatScenarioAsync(scenario, getAnswerFunc);
            Log();
            Log("----------------------------------");
            Log();
        }
